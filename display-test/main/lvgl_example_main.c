...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "Turn on Enable Pin");
    ...
    ESP_LOGI(TAG, "Set RD Pin high");
    gpio_config_t input_conf = {
        .mode = GPIO_MODE_OUTPUT,
        .pin_bit_mask = 1ULL << EXAMPLE_PIN_NUM_RD};
    ESP_ERROR_CHECK(gpio_config(&input_conf));
    gpio_set_level(EXAMPLE_PIN_NUM_RD, EXAMPLE_LCD_BK_LIGHT_ON_LEVEL);
    ...
    lv_disp_draw_buf_init(&disp_buf, buf1, buf2, LVGL_LCD_BUF_SIZE );
